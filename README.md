...
<!-- [![Build Status](https://github.com/cryingcode/NxCoreApi002optionHeaderSpin/actions/workflows/build.yml/badge.svg?branch=main)](https://github.com/cryingcode/NxCoreApi002optionHeaderSpin/actions/workflows/build.yml) -->
...
## Licensing
- **Proprietary components** (libnx.so, NxCoreAPI.h, original Sample2 logic):
